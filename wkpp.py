...
def kmeans_plusplus_w(
    ...
    centers, indices = _kmeans_plusplus_w(
        X, n_clusters, x_squared_norms, random_state, n_local_trials,w
    )

    return centers, indices

def _kmeans_plusplus_w(X, n_clusters, x_squared_norms=None, random_state=None, n_local_trials=None,w=None):
